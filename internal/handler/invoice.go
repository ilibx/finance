...
func NewInvoiceHandler(invoiceService *invoiceService.InvoiceService, orderService *orderService.OrderService) *InvoiceHandler {
...
invoice, err := h.invoiceService.CreateInvoice(r.Context(), req.OrderID, order.UserID, order.TotalAmount.Amount, req.TaxRate)
if err != nil {
writeJSON(w, http.StatusInternalServerError, APIResponse{
Success: false,
